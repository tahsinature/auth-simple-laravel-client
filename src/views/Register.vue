    ...
    <div class="container">
      <div class="login">
        ...
        <form method="post" @submit.prevent="registerUser">
          <input type="text" placeholder="Full Name" required="required" v-model="fullName">
          ...
          >
          <div class="loader text-center mb-2" v-if="isLoading">
            <div class="spinner-grow" role="status">
              <span class="sr-only">Loading...</span>
            </div>
          </div>
          <button type="submit" class="btn btn-primary btn-block btn-large">Let me register</button>
        </form>
      </div>
    </div>
  </div>
