    ...
    <div class="container">
      <div class="login">
        ...
        <form method="post" @submit.prevent="loginUser">
          ...
          <button type="submit" class="btn btn-primary btn-block btn-large">Let me login</button>
        </form>
      </div>
    </div>
  </div>
      ...
      api.auth
        ...
        .then(({ data, headers, status }) => {
          ...
          if (status === 200) {
            ...
            localStorage.setItem('token', headers['x-token-auth']);
